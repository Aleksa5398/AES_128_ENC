...
HD_PWD='C:/Users/Rascal/Desktop/AES pokusaj 2/AES_128/AES_128/AES_128.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log round_algorithm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source round_algorithm.tcl
