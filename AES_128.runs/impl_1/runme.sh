...
HD_PWD='C:/Users/Rascal/Desktop/AES pokusaj 2/AES_128/AES_128/AES_128.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log round_algorithm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source round_algorithm.tcl -notrace
